...
public class SearchView extends JFrame
{
    ...
    public SearchView()
    {
        ...
        setLayout(null);
        tf1 = new JTextField();//검색 단어를 입력받을 tf1 생성
        bt1 = new JButton();// 단일 검색 버튼 생성

        setTitle("단일 찾기");// 타이틀 지정
        ...
        tf1.setBounds(18, 20, 200, 30);//검색 단어 입력받는 텍스트필드 컴포넌트의 절대 위치 설정
        bt1.setBounds(245, 20, 110, 30);// 버튼 컴포넌트의 절대 위치 설정

        bt1.setText("단일 찾기");// 버튼에 "단일 찾기" 텍스트가 보이도록 설정
